...
?>
<div id="profile"> 
	<div style="width:40%; height:280px; margin:auto; margin-top:220px;border: 3px solid rgba(255, 255, 255, 0.43); background:#999999"> 
        ...
        <button class="btn btn-outline-dark" style="width:25%; margin-left:38%; height:45px; font-size:24px; margin-top:30px" onclick="DNprofile()"><i class="fas fa-unlock-alt"></i></button>
